		...
		<body class="hold-transition sidebar-mini layout-fixed">
			<div class="wrapper">
               ...
               with font-awesome or any other icon font library -->
								<li class="nav-item menu-open"><a href="<c:url value='/admin'/>" class="nav-link"> <i
								...
								<li class="nav-item menu-open"><a href="#" class="nav-link active"> <i
									...
									<ul class="nav nav-treeview">
										<li class="nav-item"><a href="<c:url value='/admin/video?action=view'/>"
												class="nav-link active"> <i class="far fa-circle nav-icon"></i>
												<p>Overview</p>
											</a></li>
										<li class="nav-item"><a href="<c:url value='/admin/video?action=add'/>"
												class="nav-link">
											...
											<tr>
												...
												<td>
													<button type="button" class="btn btn-block btn-danger btn-sm"
														onclick="deleteVideo('${item.href}')">Delete</button>
												</td>
											</tr>
										</c:forEach>
									</tbody>
